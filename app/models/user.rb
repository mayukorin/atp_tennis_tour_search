class User < ApplicationRecord
    ...
    def get_favorite_player_and_recently_matches
        @latest_and_second_player_matches_ids_per_players = PlayerMatch.get_latest_and_second_player_matches_ids_per_players
        return favorite_players.eager_loading.where("player_matches.id in (?)", @latest_and_second_player_matches_ids_per_players)
    end
end
