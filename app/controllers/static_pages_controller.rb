class StaticPagesController < ApplicationController
  def home
    if logged_in?
      ...
      @favorite_players_and_recently_matches = current_user.get_favorite_player_and_recently_matches
      # @favorite_players_and_recently_matches = current_user.favorite_players.eager_loading.order("matches.day DESC").limit(2)
      # puts @favorite_player_recently_matches
